...
const cases: Array<{ message: string; canSend: boolean }> = [
  ...
  { message: 'You are stupid.', canSend: false },
  { message: 'You are pathetic.', canSend: false },
  { message: 'Du er dum.', canSend: false },
  { message: 'Du er sindssyg.', canSend: false },
  { message: 'I er sindssyge.', canSend: false },
  { message: 'Du er retarderet.', canSend: false },
  { message: 'Det er latterligt.', canSend: false },
